...
/**
 * Created by krishnakumar on 01-04-2016.
 */
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private String READ_MORE ="read more";

    private String READ_LESS ="read less";
    ...
    public void onClick(View view) {
        ...
        mButton.setText(mCollapsed?READ_MORE:READ_LESS);
    ...
    private void findViews() {
        ...
        mButton.setPaintFlags(Paint.UNDERLINE_TEXT_FLAG);
